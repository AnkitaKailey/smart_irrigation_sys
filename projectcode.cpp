...
String apiKey = "24JZJGC2KOOR90C9"; // Enter your Write API key here 
const char* server = "api.thingspeak.com"; 
const char *ssid = "Ankita"; // Enter your WiFi Name 
const char *pass = "ankita12"; // Enter your WiFi Password 
